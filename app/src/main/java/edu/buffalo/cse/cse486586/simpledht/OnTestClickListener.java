...
public class OnTestClickListener implements OnClickListener {
	...
	public OnTestClickListener(TextView _tv, ContentResolver _cr, String myport) {
		mTextView = _tv;
	...
	private ContentValues[] initTestValues() {
		...
		for (int i = 0; i < TEST_CNT; i++) {
			...
			cv[i].put(KEY_FIELD, "key" + Integer.toString(i) + "_" + port);
			cv[i].put(VALUE_FIELD, "val" + Integer.toString(i) + "_" + port) ;
		}
